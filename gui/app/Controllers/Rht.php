...
class Rht extends BaseController
{
	...
	public function sensor_values()
	{
		...
		$data["vacuum"] = round((-0.00392156862745098 * explode(";", $analyzer)[3]) + 1, 6); //round((-0.00392156862745098 * $sensor[2][0]) + 1,6) // round((-0.00784313725490196 * $sensor[2][0]) + 2,6)
		$data["temp_analyzer"] = explode(";", $analyzer)[4] * 1;
